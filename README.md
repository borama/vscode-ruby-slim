...
The [**Slim Language** extension](https://marketplace.visualstudio.com/items?itemName=borama.ruby-slim) brings [Slim template language](https://github.com/slim-template/slim) support to VS Code.
